...
class LineChartConfirmedWidget extends StatelessWidget {
  final Datum country;
  final int graph;
  LineChartConfirmedWidget({this.country, this.graph});
  @override
    ...
    return Container(
      ...
      child: LineChart(
        LineChartData(
          minX: 0,
          maxX: 7,
          minY: 0.9999 * country.confirmedm7.toDouble(),
          maxY: 1.0001 * country.confirmed.toDouble(),
  ...
  List<FlSpot> getLineData() {
    ...
    list.add(
      FlSpot(7, (country.confirmed).toDouble()),
    );
    list.add(
      FlSpot(6, (country.confirmedm1).toDouble()),
    );
    list.add(
      FlSpot(5, (country.confirmedm2).toDouble()),
    );
    list.add(
      FlSpot(4, (country.confirmedm3).toDouble()),
    );
    list.add(
      FlSpot(3, (country.confirmedm4).toDouble()),
    );
    list.add(
      FlSpot(2, (country.confirmedm5).toDouble()),
    );
    list.add(
      FlSpot(1, (country.confirmedm6).toDouble()),
    );
    list.add(
      FlSpot(0, (country.confirmedm7).toDouble()),
    );
  ...
  double interval() {
    double interval;
    int range = country.confirmed - country.confirmedm7;
    if (range < 10) {
      interval = 1;
